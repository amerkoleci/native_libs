...
ALIMER_IMAGE_API Image* alimerImageFromMemory(const void* data, size_t size);
...
ALIMER_IMAGE_API bool32 alimerImageIsArray(Image* image);
ALIMER_IMAGE_API bool32 alimerImageIsCubemap(Image* image);
...
ALIMER_IMAGE_API bool32 image_save_png_memory(Image* image, image_save_callback callback);
